...
int main()
{
    cout << "enter a velue of m & n for m*n " << endl;
    int m, n;
    cin >> m >> n;

    cout << "Enter the original co-ordinates " << endl;
    int src_x, src_y;
    cin >> src_x >> src_y;

    cout << "Enter the destinatin co-ordinates " << endl;
    int dest_x, dest_y;
    cin >> dest_x >> dest_y;

    string output = "";
    cout << "ways to to reach from Origin to Destination are as follows " << endl;
